...
python tools/train_net_step.py --cfg configs/dt/e2e_faster_rcnn_R-101-FPN_clipart_weakly_1stream_noreg_freeze-boxhead_unlock-rpn-conv.yaml --load_ckpt $dir/model_step9999.pth --use_tfboard --dataset clipart --bs 32 2>&1|tee log/train_1stream_noreg_freeze-boxhead_unlock-rpn-conv.from_baseline.2e-5.1117.log
