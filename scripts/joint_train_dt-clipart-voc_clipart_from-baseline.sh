...
python tools/train_net_step.py --cfg $config --load_ckpt $pretrain --use_tfboard --dataset $dataset --bs 32 2>&1|tee log/joint_train_dt-clipart-voc_clipart.from_baseline.4e-5.1115.log
